    ...
    <section className="py-24 bg-slate-50 dark:bg-slate-900/50 overflow-hidden relative transition-colors duration-500">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 relative max-w-4xl mx-auto">
          ...
          <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-16 h-16 bg-white dark:bg-slate-800 rounded-full shadow-2xl border-4 border-slate-50 dark:border-slate-900 items-center justify-center transition-colors duration-500">
            <span className="text-xl font-black text-gray-300 dark:text-gray-500">VS</span>
          </div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full md:w-1/2 bg-white dark:bg-slate-800 rounded-[32px] p-8 md:p-12 shadow-xl border-t-8 border-red-500 relative transition-colors duration-500"
          >
            ...
            <h3 className="text-5xl font-black text-brand-dark dark:text-white mb-8 tracking-tight">$7,500 <span className="text-2xl text-gray-300 dark:text-gray-500 font-normal">MXN</span></h3>
            
            <ul className="space-y-4 text-gray-600 dark:text-gray-400">
              <li className="flex items-start gap-3 border-b border-gray-100 dark:border-slate-700 pb-4">
